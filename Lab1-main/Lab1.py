"""
Лабораторна робота: Логістична регресія для аналізу тональності відгуків про фільми

Використовуємо NLTK corpus 'movie_reviews' (Sentiment Polarity Dataset Version 2.0)
"""
...
def load_movie_reviews():
    pos_texts = [" ".join(movie_reviews.words(fileid)) for fileid in movie_reviews.fileids('pos')]
    neg_texts = [" ".join(movie_reviews.words(fileid)) for fileid in movie_reviews.fileids('neg')]
